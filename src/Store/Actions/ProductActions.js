...
export const fetchProducts = (pageNumber = 1) => {
  return (dispatch) => {
    ...
    axios
      .get(`http://localhost:9000/products?pageNo=${pageNumber}`)
      .then((response) => {
        dispatch(
          fetchSuccessAction({
...
export const createProduct = (productInfo) => {
  return (dispatch) => {
    dispatch(fetchProductDataAction);
    axios
      .post(`http://localhost:9000/products/add-product`,productInfo,{}
       )
      .then((data) => {
...
export const updateProduct = (productInfo) => {
  ...
  return (dispatch) => {
    dispatch(fetchProductDataAction);
    axios
      .patch(`http://localhost:9000/products/update-product`, productInfo)
      .then((data) => {
...
export const deleteProduct = (productId) => {
  return (dispatch) => {
    dispatch(fetchProductDataAction);
    axios
      .delete(`http://localhost:9000/products/delete-product/${productId}`)
      .then((response) => {
